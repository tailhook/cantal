...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilRouting = __webpack_require__(37);

	var _utilRouting2 = _interopRequireDefault(_utilRouting);

	var _templatesNavbarMft = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	        ...
	        function millis_time(tm) {
	            return millis_delta(till_now_ms(from_ms(tm)));
	        }
	        function millis_delta(delta) {
	            return ((delta)?(((delta < 10000)?(String(delta) + " ms"):(format_diff(delta)))):("never"));
	        }
	        function peer_row(p) {
	            return {
	                    key: "b-peers:peer_row",
	                    children: [
	                        {
	                            tag: "td",
	                            children: {children: [
	                        ...
	                        },
	                        {
	                            ...
	                            children: ((p.last_report_direct)?({children: [
	                        ...
	                        },
	                        {
	                            ...
	                            children: ((p.roundtrip !== null)?({children: [
	                                ...
	                                ((p.random_peer_roundtrip)?({
	                                    tag: "div",
	                                    attrs: {
	                                        title: String(p.random_peer_roundtrip[0]),
	                                        class: "b-peers tiny",
	                                    },
	                                    children: {children: [
	                        ...
	                        },
	                        {
	                            ...
	                            children: ((p.peers !== null)?({children: [
	                                String(p.peers),
	                                {
	                                    tag: "div",
	                                    attrs: {class: "b-peers tiny"},
	                                    children: millis_time(p.report),
	                                },
	                            ]}):("∅")),
	                        },
	                        {
	                                ...
	                                children: {children: [
	                                    ...
	                                    },
	                                    {
	                                        ...
	                                        children: {
	                                            tag: "p",
	                                            attrs: {class: "b-peers col-xs-12"},
	                                            children: ((peers)?(((peers.length > 0)?({children: [
	                                                {
	                                                    tag: "table",
	                                                    ...
	                                                    children: {children: [
	                                                        ...
	                                                        },
	                                                        {
	                                                            ...
	                                                            children: peers.map(function (p) {
	                                                                return {
	                                                                        tag: "tr",
	                                                                        children: ((p.report && till_now_ms(from_ms(p.report)) <= 5 * 60 * 1000)?(peer_row(p)):("")),
	                                                                        key: p.id,
	                                                                    };
	                                                            }),
	                                                        },
	                                                ...
	                                                {
	                                                    tag: "h3",
	                                                    children: "Old/Inactive/Failing Peers",
	                                                },
	                                                {
	                                                    tag: "table",
	                                                    attrs: {class: "b-peers table table-bordered table-hover"},
	        ...
	        exports.millis_delta = millis_delta
	        exports.peer_row = peer_row
	        exports.render = render
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
	        ...
	        function peer_row(p, name) {
	            return {
	                    ...
	                    children: [
	                        ...
	                        {
	                            tag: "td",
	                            attrs: {title: p.last_attempt && p.last_attempt[1]},
	                            children: ((p.connected)?(String(p.connected)):({children: [
	                                "no,",
	                                {
	                                    tag: "div",
	                                    attrs: {class: "b-list tiny"},
	                                    children: ((p.last_attempt)?(format_diff(till_now_ms(from_ms(p.last_attempt[0])))):("???")),
	                                },
	                            ]})),
	                        },
	                        {
	                            ...
	                            children: {children: [
	                                ...
	                                },
	                                {
	                                    ...
	                                    children: peers.map(function (p) {
	                                        return {
	                                                tag: "tr",
	                                                children: ((p.last_beacon && till_now_ms(from_ms(p.last_beacon_time)) < 5 * 60 * 1000)?(peer_row(p, peer_map[p.id])):("")),
	                                                key: p.id,
	                                            };
	                                    }),
	                                },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	    ...
	    ], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, _mod_util_query, _mod_util_compute, donut, sparkline, _mod_util_format, _mod_pages_remote, _mod_util_template) {
	        ...
	        function render_peer(stats, name, port, cpu_yaxis) {
	            return ((stats && stats.get("cpu_idle").chunks.length)?({
	                    ...
	                    tag: "div",
	                    attrs: {class: "b-grid peer unknown"},
	                    children: {children: [
	                        {
	                            tag: "div",
	                    ...
	                    children: function (old_node) {
	                        ...
	                        return {
	                                ...
	                                children: {children: [
	                                    ...
	                                    {
	                                        tag: "div",
	                                        attrs: {class: "b-grid peer-container"},
	                                        children: Object.keys(peer_map).concat("myself").map(function (peer) {
	                                            return add_key(peer, render_peer(grid_query.response && grid_query.response.get(peer), peer_map[peer] || peer.split(":")[0], get_port(peer), cpu_yaxis));
	                                        }),
	                                    },
	                                ]},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	        ...
	        function render_status(beacon) {
	            return {
	                    key: "b-navbar:render_status",
	                    children: function (old_node) {
	                        var query = old_node && old_node.store_query || new Query(2000, {
	                                self_cpu: {
	                                    series: {
	                        ...
	                        return {
	                                ...
	                                children: {children: [
	                                    render_graphs(beacon, query.values),
	                                    {
	                                        tag: "div",
	                                        attrs: {class: "b-navbar flex-vert"},
	                                        children: {children: [
	                                            {
	                                                tag: "div",
	                                                attrs: {
	                                                    title: "Uptime of the box running cantal",
	                                                    class: "b-navbar machine pointer",
	                                                },
	                                                children: {children: [
	                                                    "up ",
	                                            ...
	                                            {
	                                                tag: "div",
	                                                attrs: {class: "b-navbar self"},
	                                                children: render_self(beacon, websock.connected, query.values && query.values.get("self_cpu"), query.values && query.values.get("self_mem").to_dict("metric")),
	                                            },
	                                        ]},
	                                    },
	                                ]},
	        ...
	        function render_graphs(beacon, stats) {
	            return ((stats)?({
	                    key: "b-navbar:render_graphs" + ":0",
	                    children: function (old_node) {
	                        var cpu_yaxis = {
	                                height: 40,
	                                bg_color: "rgb(237,248,233)",
	                    ...
	                    children: function (old_node) {
	                        ...
	                        return {
	                                ...
	                                children: {children: [
	                                    ...
	                                    ((beacon)?({
	                                        tag: "div",
	                                        attrs: {class: "b-navbar hostinfo"},
	                                        children: String(beacon.name) + " / " + String(beacon.hostname) + " / " + String(beacon.id),
	                                    }):("")),
	                                ]},
	                            };
	                    },
	        ...
	        exports.render_graphs = render_graphs
	        exports.render = render
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
