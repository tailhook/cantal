	                                ...
	                                return {
	                                        ...
	                                        children: {children: [
	                                            ...
	                                            },
	                                            {
	                                                ...
	                                                children: ((m[1].variant === "State")?(String(m[1].variant) + "(" + String(m[1].fields[1]) + ")"):(String(m[1].variant) + "(" + String(m[1].fields[0]) + ")")),
	                                            },
	                                        ]},
	                                    };
	                            })):("")),
	                                                        ...
	                                                        return {
	                                                                ...
	                                                                children: {children: [
	                                                                    ...
	                                                                    },
	                                                                    {
	                                                                        ...
	                                                                        children: ((p.probe)?(format_diff(till_now_ms(from_ms(p.probe)))):("never")),
	                                                                    },
	                                                                    {
	                                                                        tag: "td",
	                                                                        attrs: {class: "b-peers" + " " + ((p.report === null)?("text-muted"):(""))},
	                                                                        children: ((p.report !== null)?(format_diff(till_now_ms(from_ms(p.report)))):("never")),
	                                                                    },
	                                                                    {
	                                                                        tag: "td",
	                ...
	                if (data instanceof Error) {
	                    ...
	                    try {
	                        for (var _iterator = data.peers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                            ...
	                            var _name = peer.hostname || peer.addr.split(':')[0];
	                            peer_map[peer.addr] = _name;
	                        }
	                    } catch (err) {
	                        _didIteratorError = true;
	                        _iteratorError = err;
	                                        ...
	                                        children: {children: [
	                                            ...
	                                            ((!peers_request.peers)?({
	                                                ...
	                                                children: peers_request.peers.map(function (peer) {
	                                                    return function (old_node) {
	                                                            var port = peer.addr.split(":")[1];
	                                                            return {
	                                                                    tag: "li",
	                                                                    children: ((peer.hostname)?({children: [
	                                                                        {
	                                                                            tag: "a",
	                                                                            attrs: {href: "http://" + String(peer.hostname) + ":" + String(port) + "/"},
	                                                                            children: "http://" + String(peer.hostname) + ":" + String(port) + "/",
	                                                                        },
	                                                                        " (" + String(peer.addr) + ")",
	                                                                    ]}):({children: [
	                                                                        {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RemoteStats = (function (_JsonQuery3) {
	    _inherits(RemoteStats, _JsonQuery3);

	    function RemoteStats(interval) {
	        _classCallCheck(this, RemoteStats);

	        _get(Object.getPrototypeOf(RemoteStats.prototype), 'constructor', this).call(this);
	...
	var PeersRequest = (function (_JsonQuery4) {
	    _inherits(PeersRequest, _JsonQuery4);

	    function PeersRequest(only_remote, interval) {
	        _classCallCheck(this, PeersRequest);

	        _get(Object.getPrototypeOf(PeersRequest.prototype), 'constructor', this).call(this);
	                            ...
	                            children: peers.map(function (p) {
	                                return {
	                                        ...
	                                        children: {children: [
	                                            ...
	                                            ((peer_map[p.addr])?(function (old_node) {
	                                                var port = p.addr.split(":")[1];
	                                                return {
	                                                        tag: "td",
	                                                        children: {children: [
	                                                            ...
	                                                            " ",
	                                                            {
	                                                                tag: "a",
	                                                                attrs: {
	                                                                    href: "http://" + String(peer_map[p.addr]) + ":" + String(port),
	                                ...
	                                },
	                                {
	                                    ...
	                                    children: Object.keys(peer_map).concat("myself").map(function (peer) {
	                                        return function (old_node) {
	                                                ...
	                                                return {
	                                                        tag: "div",
	                                                        children: ((grid_query.response && grid_query.response[peer])?(function (old_node) {
	                                                            var stats = grid_query.response[peer];
