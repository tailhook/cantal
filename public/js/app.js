	                                                    ...
	                                                    children: {children: [
	                                                        ...
	                                                        },
	                                                        {
	                                                            ...
	                                                            children: peers.map(function (p) {
	                                                                return ((p.report && till_now_ms(from_ms(p.report)) <= 5 * 60 * 1000)?(peer_row(p)):({
	                                                                        tag: "tr",
	                                                                        key: p.id + ":1",
	                                                                    }));
	                                                            }),
	                    ...
	                    children: [
	                        {
	                            ...
	                            children: {children: [
	                                ...
	                                },
	                                {
	                                    tag: "tbody",
	                                    children: peers.map(function (p) {
	                                        return ((p.last_beacon && till_now_ms(from_ms(p.last_beacon_time)) < 5 * 60 * 1000)?(peer_row(p, peer_map[p.id])):({
	                                                tag: "tr",
	                                                key: p.id + ":1",
	                                            }));
	                                    }),
	                                ...
	                                children: {children: [
	                                    ...
	                                    },
	                                    {
	                                        ...
	                                        children: Object.keys(peer_map).concat("myself").map(function (peer) {
	                                            return render_peer(grid_query.response && grid_query.response.get(peer), peer_map[peer] || peer.split(":")[0], get_port(peer), cpu_yaxis);
	                                        }),
	                                    },
	                                ]},
