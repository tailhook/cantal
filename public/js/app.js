	                                                            ...
	                                                            return {
	                                                                    ...
	                                                                    children: {children: [
	                                                                        ...
	                                                                        },
	                                                                        {
	                                                                            ...
	                                                                            children: ((p.primary_addr)?(String(p.primary_addr)):("?/" + String(p.addresses.length))),
	                                                                        },
	                                                                        function (old_node) {
	                                                                        ...
	                                                                        },
	                                                                        {
	                                                                            ...
	                                                                            children: ((p.probe_time)?(function (old_node) {
	                                                                                var delta = till_now_ms(from_ms(p.probe_time));
	                                                                                return {
	                                                                                        tag: "span",
	                                                                        ...
	                                                                        },
	                                                                        {
	                                                                            ...
	                                                                            children: ((p.report)?(function (old_node) {
	                                                                                var delta = till_now_ms(from_ms(p.report));
	                                                                                return {
	                                                                                        tag: "span",
	                                                                                        children: ((delta < 10000)?(String(delta) + " ms"):(format_diff(delta))),
	                                                                                    };
	                                        ...
	                                        children: Object.keys(peer_map).concat("myself").map(function (peer) {
	                                            return {
	                                                    ...
	                                                    children: function (old_node) {
	                                                        ...
	                                                        return {
	                                                                tag: "div",
	                                                                children: ((grid_query.response && grid_query.response.has(peer))?(function (old_node) {
	                                                                    var stats = grid_query.response.get(peer);
